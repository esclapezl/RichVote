...
<div class="block">
    <div class="text-box">
        ...
        <?php foreach ($propositions as $proposition) {
            echo '<li class="ligneExt"><a class="atxt" href=frontController.php?controller=proposition&action=read&id=' . rawurlencode($proposition->getIdProposition()) . '>' . htmlspecialchars($proposition->getIntitule()) . '</a></li>';
        }?>
        </ul>
    </div>
</div>

...
<div class="block">
    <div class="text-box">
        ...
        <?php foreach ($propositions as $proposition) {
            echo '<div class="ligneExt"><li class="ligneExt"><a href= frontController.php?controller=proposition&action=read&id=' . $proposition->getIdProposition() . '>' . $proposition->getIdProposition() . '</a></li></div>';
        }?>
        </ul>
    </div>
</div>

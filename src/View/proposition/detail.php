...
<div class="block">
    <div class="text-box">
        <div class="ligneExt"> <div><a id="fleche" class="optQuestion" href=<?=$_SERVER['HTTP_REFERER']?>>↩</a><h1><?=htmlspecialchars($proposition->getIntitule())?></h1></div> <h3>Détail de la proposition</h3></div>
